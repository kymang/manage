...
from Amang.core.tasks import _get_tasks_text, all_tasks, rm_task
from Amang.modules.info import get_chat_info, get_user_info
from Amang.modules.music import download_youtube_audio
from Amang.utils.functions import test_speedtest
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/22ac4d99bc82a6a5c0d46.jpg",
        ...
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent(
                "https://github.com/Amang1503/AmangRobot"
            ),
            thumb_url="https://telegra.ph/file/22ac4d99bc82a6a5c0d46.jpg",
        ),
    ]
...
async def alive_function(answers):
    ...
    bot_state = "Dead" if not await app.get_me() else "Active"
    ubot_state = "Dead" if not await app2.get_me() else "Active"
    buttons.add(
    ...
    msg = f"""
**[ᴀᴍᴀɴɢꝛσʙσᴛ](https://t.me/AmangRobot_bot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{app.me.username}) | [UBOT](t.me/{app2.me.username})
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def pmpermit_func(answers, user_id, victim):
    if user_id != app2.me.id:
        return
    caption = f"Hi, I'm {app2.me.first_name} {app2.me.last_name or ''}, What are you here for?, You'll be blocked if you send more than 5 messages."
    buttons = InlineKeyboard(row_width=2)
    buttons.add(
        InlineKeyboardButton(
            text="Saya Scammer", callback_data="pmpermit to_scam_you a"
        ),
        InlineKeyboardButton(
            text="Untuk promosi",
            callback_data="pmpermit to_scam_you a",
        ),
        InlineKeyboardButton(text="Setujui Saya", callback_data="pmpermit approve_me a"),
        InlineKeyboardButton(
            text="Setujui", callback_data=f"pmpermit approve {victim}"
        ),
        InlineKeyboardButton(
            text="Hapus + Blokir",
