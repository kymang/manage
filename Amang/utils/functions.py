...
from Amang import aiohttpsession as aiosession
from Amang.utils.dbfunctions import start_restart_stage
from Amang.utils.http import get, post
...
def generate_captcha():
    ...
    height = 100
    correct_answer = ""
    font = ImageFont.truetype("Amang/resources/fonts/arial.ttf", 55)
    file = f"Amang/resources/{randint(1000, 9999)}.jpg"
