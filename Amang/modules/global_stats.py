...
from Amang.utils.inlinefuncs import keywords_list
...
async def clean_db(_, message):
    ...
    for served_chat in served_chats:
        try:
            await app.get_chat_members(served_chat, app.me.id)
...
async def global_stats(_, message):
    ...
    msg = f"""
**Global Stats of {app.me.first_name + (app.me.last_name or "")}**:
...
**Global Stats of {app2.me.first_name + (app2.me.last_name or "")}**:
    **{total_ub} Dialogs.**
