...
from Amang.utils.functions import get_http_status_code, get_urls_from_text
from Amang.utils.rss import Feed
    ...
    while True:
        ...
        for _feed in feeds:
            ...
            try:
                ...
                LOGGER(__name__).info(f"Removed RSS Feed from {chat} (Invalid Chat)")
            except Exception as e:
                LOGGER(__name__).info(f"RSS in {chat}: {str(e)}")
        await sleep(RSS_DELAY)
