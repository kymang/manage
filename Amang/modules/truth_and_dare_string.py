...
TRUTH = [
    ...
    "Apabila kamu cewe bersedia kah untuk menjadi pacar owner ku @kenapanan atau @rizzvbss",
    ...
    "@kenapanan atau @rizzvbss menurut ku dia ganteng, coba deh kamu chat, trus ajak pacaran hehe ⚠️WARNING ini khusus cewe ya!",
...
DARE = [
     ...
     "Bilang ke @kenapanan atau @rizzvbss bahwa dia ganteng",
]
